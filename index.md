...
<div style="margin-left: 2em;">  <!-- pour aligner le tableau -->
  ...
  | Domaine                   | Compétences                                                                                                                                                                                                                                                                                     |
  | ------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
  | Compétences techniques    | • Développement de scripts <br> • Environnement technique : <br>&nbsp;&nbsp; Linux, Docker, Git, Jenkins, Kubernetes, Cloud AWS <br> • Détection d’anomalies et investigation                                                                                                                                    |
